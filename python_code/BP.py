...
class BP:
    ...
    def initialise(self, data, label,trapro,valpro,process):
        ...
        for l in range(1, self.layers):
            ...
            # locals()['W' + str(l)] = np.random.uniform(-np.sqrt(6 / self.neures_array[l - 1]),np.sqrt(6 / self.neures_array[l - 1]), (self.neures_array[l], self.neures_array[l - 1]))  # He initiation
...
print('The accuracy is',str(max(max(acc_table))*100),'%')
